...
function setupBasePackages() {
	...
	sudo apt-get install -y libgnome-keyring-dev radiotray gimp xmlstarlet jq enpass vim libnss-mdns:i386 dkms makemkv-bin makemkv-oss handbrake-gtk nmap google-chrome-stable gdebi kodi kodi-pvr-hts insync insync-caja git ubuntu-make nodejs nodejs-legacy npm
